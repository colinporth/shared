...
public:
  cAudioDecode() {}
  cAudioDecode (iAudioDecoder::eFrameType frameType);
  ~cAudioDecode();
  ...
  static iAudioDecoder::eFrameType parseSomeFrames (uint8_t* framePtr, uint8_t* frameLast, int32_t& sampleRate);
  static iAudioDecoder::eFrameType parseAllFrames (uint8_t* framePtr, uint8_t* frameLast, int32_t& sampleRate);
