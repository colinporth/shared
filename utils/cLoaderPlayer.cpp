...
//}}}
//{{{
class cNitTsParser : public cTsParser {
public:
...
//}}}
//{{{
class cSdtTsParser : public cTsParser {
public:
...
//}}}
//{{{
class cEitTsParser : public cTsParser {
public:
  cEitTsParser() : cTsParser (0x12, "eit") {}
  virtual ~cEitTsParser() {}
...
//}}}
//{{{
class cTdtTsParser : public cTsParser {
public:
