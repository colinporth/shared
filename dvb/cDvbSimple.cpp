...
//{{{
void cDvbSimple::tune (int frequency) {
...
//}}}
//{{{
bool cDvbSimple::getTsBlock (uint8_t*& block, int& blockSize) {
    ...
    while (true) {
      int blockSize = 0;
      block = mBipBuffer->getContiguousBlock (blockSize);
      if (blockSize > 0) {
...
//}}}
//{{{
void cDvbSimple::releaseTsBlock (int blockSize) {
